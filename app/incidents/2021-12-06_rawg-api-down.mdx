...
<UpdateSection 
  title="Monitoring" 
  description={`We are closely monitoring the situation and we'll keep you updated about any significant development.
...
Since the API isn't currently available, you'll see lots of error messages if you have linked your games to the RAWG database. This issue shouldn't however, cause a crash of the app.`} 
  date={new Date("2021-12-06T15:40:32.659Z")} 
/>

<UpdateSection 
  title="Monitoring" 
  description={`Here what's new since the last update:
...
_Thank you for your patience._`} 
  date={new Date("2021-12-06T19:50:22.889Z")} 
/>

<UpdateSection 
  title="Resolved" 
  description="The issue is now resolved. All Gavilya's services should work as expected." 
  date={new Date("2021-12-07T14:24:34.302Z")} 
/>
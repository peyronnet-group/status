...
var appendUpdateSection = function (filePath, title, message) {
    var updateSection = "\n<UpdateSection title={" + JSON.stringify(title) + "} date={new Date(\"" + new Date().toISOString() + "\")}>\n  " + message + "\n</UpdateSection>\n";
    fs.appendFileSync(filePath, updateSection);
    console.log("Update section appended to " + filePath);
};
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mdxFiles, selectedFile, title, message, filePath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prompts_1.input({ message: "Enter the title:" })];
            case 2:
                title = _a.sent();
                return [4 /*yield*/, prompts_1.input({ message: "Enter the message:" })];
            case 3:
                message = _a.sent();
                filePath = path.join("../app/incidents", selectedFile);
